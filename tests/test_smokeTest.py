...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("alalalal")
    self.driver.find_element(By.ID, "password").send_keys("alalala")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "biztitle").send_keys("S")
